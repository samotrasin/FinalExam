    ...
    public class CuisineList
    {
        public List<Cuisine> Cuisines { get; set; } = [
            new Cuisine
            {
                ...
                {
                    Name = "Samlor Korko",
                    Ingredients = ["Prahok", "Pork", "Fish", "Vegetables"],
                    Images = ["./Images/Somlorkorko.jpg"],
                    Instructions = "Samlor Korko is a traditional Khmer soup made with prahok, pork, fish, and vegetables. "
                },
                    new Recipe
                    {
                        Name = "Trorb Dott",
